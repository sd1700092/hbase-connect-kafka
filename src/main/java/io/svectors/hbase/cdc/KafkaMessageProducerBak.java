 ...
 * @author ravi.magham
 */
public final class KafkaMessageProducerBak implements Closeable {

    private static final Logger LOG = LoggerFactory.getLogger(KafkaMessageProducerBak.class);
	 ...
	 */
    public KafkaMessageProducerBak(final KafkaConfiguration kafkaConfiguration) {
