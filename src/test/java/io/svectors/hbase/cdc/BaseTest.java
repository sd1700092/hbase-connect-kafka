...
//		hbaseConf.set("kafka.bootstrap.servers", "172.31.217.111:9092,172.31.217.115:9092,172.31.217.124:9092");
...
//		hbaseConf.set("kafka.value.serializer", "io.svectors.hbase.cdc.serde.HRowProtobufSerde");
	 ...
	 * @return
	 */
	public KafkaConsumer<byte[], String> createAndGetKafkaConsumer() {
...
//		props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, "io.svectors.hbase.cdc.serde.HRowProtobufSerde");
		...
		final KafkaConsumer<byte[], String> consumer = new KafkaConsumer<>(props);
		return consumer;
	}
}
